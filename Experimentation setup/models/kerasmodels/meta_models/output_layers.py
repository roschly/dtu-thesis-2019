...
hidden_act = meta_learner_hidden_activation
out_act = meta_learner_output_activation
...
def _create_encoder_model():
    ...
    # x = Conv2D(filters=16, kernel_size=3, strides=2, padding="same", activation=hidden_act, kernel_regularizer=l2(l2_val) )(encoder_input)
